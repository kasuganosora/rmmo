...
func _on_status_cancel_requested(status_id: String) -> void:
	QuestPanel._on_status_cancel_requested(self, status_id)
...
func apply_quest_snapshot(quests: Array) -> void:
	QuestPanel.apply_quest_snapshot(self, quests)
...
func _build_quest_tracker() -> void:
	QuestPanel._build_quest_tracker(self, )
func _default_quest_tracker_pos() -> Vector2:
	return QuestPanel._default_quest_tracker_pos(self, )
func _place_quest_tracker() -> void:
	QuestPanel._place_quest_tracker(self, )
func _refresh_quest_tracker() -> void:
	QuestPanel._refresh_quest_tracker(self, )
func _fit_quest_tracker() -> void:
	QuestPanel._fit_quest_tracker(self, )
func _open_tracked_quest(quest_id: String) -> void:
	QuestPanel._open_tracked_quest(self, quest_id)
func _quest_nav_world_ctx() -> Dictionary:
	return QuestPanel._quest_nav_world_ctx(self, )
func _find_tracked_quest_row(quest_id: String) -> Dictionary:
	return QuestPanel._find_tracked_quest_row(self, quest_id)
func _resolve_tracked_quest_nav(quest_id: String, objective_index: int = -1) -> Dictionary:
	return QuestPanel._resolve_tracked_quest_nav(self, quest_id, objective_index)
func _path_to_tracked_quest(quest_id: String, objective_index: int = -1) -> void:
	QuestPanel._path_to_tracked_quest(self, quest_id, objective_index)
...
func _on_tracked_quest_activate(quest_id: String, objective_index: int = -1) -> void:
	QuestPanel._on_tracked_quest_activate(self, quest_id, objective_index)
...
func _lock_quest_window(panel: PanelContainer) -> void:
	QuestPanel._lock_quest_window(self, panel)
...
func _rebuild_quest_tab_bar(panel: PanelContainer) -> void:
	QuestPanel._rebuild_quest_tab_bar(self, panel)
func _on_quest_tab(tab_id: String) -> void:
	QuestPanel._on_quest_tab(self, tab_id)
func _highlight_quest_tabs(tabs: HBoxContainer) -> void:
	QuestPanel._highlight_quest_tabs(self, tabs)
func _on_quest_window_visibility() -> void:
	QuestPanel._on_quest_window_visibility(self, )
...
func _fill_quest(body: VBoxContainer, _ch: Dictionary) -> void:
	QuestPanel._fill_quest(self, body, _ch)
func _soft_sync_quest_drawer() -> void:
	QuestPanel._soft_sync_quest_drawer(self, )
func _quest_status_matches_tab(status: String) -> bool:
	return QuestPanel._quest_status_matches_tab(self, status)
func _normalize_quest_status(status: String) -> String:
	return QuestPanel._normalize_quest_status(self, status)
func _make_quest_row(q: Dictionary, selected: bool) -> Button:
	return QuestPanel._make_quest_row(self, q, selected)
func _quest_status_label(status: String) -> String:
	return QuestPanel._quest_status_label(self, status)
func _on_quest_row_selected(quest_id: String) -> void:
	QuestPanel._on_quest_row_selected(self, quest_id)
func _on_quest_drawer_close() -> void:
	QuestPanel._on_quest_drawer_close(self, )
func _ensure_quest_drawer() -> void:
	QuestPanel._ensure_quest_drawer(self, )
func _quest_by_id(quest_id: String) -> Dictionary:
	return QuestPanel._quest_by_id(self, quest_id)
func _place_quest_drawer() -> void:
	QuestPanel._place_quest_drawer(self, )
func _sync_quest_drawer_follow() -> void:
	QuestPanel._sync_quest_drawer_follow(self, )
func _open_quest_drawer(quest_id: String, animate: bool) -> void:
	QuestPanel._open_quest_drawer(self, quest_id, animate)
func _close_quest_drawer(animate: bool) -> void:
	QuestPanel._close_quest_drawer(self, animate)
func _finish_quest_drawer_close() -> void:
	QuestPanel._finish_quest_drawer_close(self, )
func _refresh_quest_drawer_content() -> void:
	QuestPanel._refresh_quest_drawer_content(self, )
func _on_quest_turn_in(quest_id: String) -> void:
	QuestPanel._on_quest_turn_in(self, quest_id)
func _on_quest_abandon(quest_id: String) -> void:
	QuestPanel._on_quest_abandon(self, quest_id)
...
func _detect_quest_status_toasts(quests: Array) -> void:
	QuestPanel._detect_quest_status_toasts(self, quests)
func _build_quest_toast() -> void:
	QuestPanel._build_quest_toast(self, )
...
func show_quest_complete_toast(title: String) -> void:
	QuestPanel.show_quest_complete_toast(self, title)
func _show_quest_toast(line: String, font_col: Color, border_col: Color) -> void:
	QuestPanel._show_quest_toast(self, line, font_col, border_col)
func hide_quest_toast() -> void:
	QuestPanel.hide_quest_toast(self, )
func is_quest_toast_visible() -> bool:
	return QuestPanel.is_quest_toast_visible(self, )
func get_quest_toast_text() -> String:
	return QuestPanel.get_quest_toast_text(self, )
func _layout_quest_toast() -> void:
	QuestPanel._layout_quest_toast(self, )
func _tick_quest_toast(delta: float) -> void:
	QuestPanel._tick_quest_toast(self, delta)
...
func _build_titles_panel() -> void:
	TitlesPanel._build_titles_panel(self, )
func _nudge_titles() -> void:
	TitlesPanel._nudge_titles(self, )
func _toggle_titles_panel(force_open: bool = false) -> void:
	TitlesPanel._toggle_titles_panel(self, force_open)
func apply_title_update(action: Dictionary) -> void:
	TitlesPanel.apply_title_update(self, action)
func _build_daily_panel() -> void:
	TitlesPanel._build_daily_panel(self, )
func _nudge_daily() -> void:
	TitlesPanel._nudge_daily(self, )
func _toggle_daily_panel(force_open: bool = false) -> void:
	TitlesPanel._toggle_daily_panel(self, force_open)
func apply_daily_board(action: Dictionary) -> void:
	TitlesPanel.apply_daily_board(self, action)
func _refresh_daily_panel() -> void:
	TitlesPanel._refresh_daily_panel(self, )
...
func _active_title_display_name() -> String:
	return TitlesPanel._active_title_display_name(self, )
func _ensure_title_under_name() -> void:
	TitlesPanel._ensure_title_under_name(self, )
func _refresh_name_with_title() -> void:
	TitlesPanel._refresh_name_with_title(self, )
func _title_unlock_hint(row: Dictionary) -> String:
	return TitlesPanel._title_unlock_hint(self, row)
func _refresh_titles_panel() -> void:
	TitlesPanel._refresh_titles_panel(self, )
...
func _apply_title_result_locally(result: Dictionary) -> void:
	TitlesPanel._apply_title_result_locally(self, result)
## --- 成就 panel ---

func _build_achievements_panel() -> void:
	TitlesPanel._build_achievements_panel(self, )
func _nudge_achievements() -> void:
	TitlesPanel._nudge_achievements(self, )
func _toggle_achievements_panel(force_open: bool = false) -> void:
	TitlesPanel._toggle_achievements_panel(self, force_open)
func apply_achievement_update(action: Dictionary) -> void:
	TitlesPanel.apply_achievement_update(self, action)
func _achievement_unlock_hint(row: Dictionary) -> String:
	return TitlesPanel._achievement_unlock_hint(self, row)
func _refresh_achievements_panel() -> void:
	TitlesPanel._refresh_achievements_panel(self, )
## --- Guild panel ---
