...
func get_tile(args: Dictionary) -> Dictionary:
	return _inspect_ops_logic.get_tile(args)
func get_tiles_rect(args: Dictionary) -> Dictionary:
	return _inspect_ops_logic.get_tiles_rect(args)
func list_entities(args: Dictionary) -> Dictionary:
	return _inspect_ops_logic.list_entities(args)
func list_layers() -> Dictionary:
	return _inspect_ops_logic.list_layers()
func list_tilesets() -> Dictionary:
	return _inspect_ops_logic.list_tilesets()
func get_map_settings() -> Dictionary:
	return _inspect_ops_logic.get_map_settings()
...
func preview_tileset(args: Dictionary) -> Dictionary:
	return _inspect_ops_logic.preview_tileset(args)
func preview_charset(args: Dictionary) -> Dictionary:
	return _inspect_ops_logic.preview_charset(args)
...
func pick_tileset(args: Dictionary) -> Dictionary:
	return _inspect_ops_logic.pick_tileset(args)
func find_tiles(args: Dictionary) -> Dictionary:
	return _inspect_ops_logic.find_tiles(args)
...
func get_weather() -> Dictionary:
	return _inspect_ops_logic.get_weather()
