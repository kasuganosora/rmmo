...
const TilesetManager = preload("res://scripts/editor/tileset_manager.gd")
const EditorMcp = preload("res://scripts/editor/editor_mcp.gd")
const MapMinimap = preload("res://scripts/editor/map_minimap.gd")
