...
var _equipment_module_logic: EquipmentModule = EquipmentModule.new(self)
const TitlesModule = preload("res://scripts/net/server/titles_module.gd")
var _titles_module_logic: TitlesModule = TitlesModule.new(self)
const AuctionModule = preload("res://scripts/net/server/auction_module.gd")
var _auction_module_logic: AuctionModule = AuctionModule.new(self)
const AchievementsModule = preload("res://scripts/net/server/achievements_module.gd")
var _achievements_module_logic: AchievementsModule = AchievementsModule.new(self)
...
func _append_level_up_sp(actions: Array, levels_gained: Array) -> void:
	_progression_module_logic._append_level_up_sp(actions, levels_gained)
...
func try_allocate_attr(stat_key: String, amount: int = 1) -> Dictionary:
	return _progression_module_logic.try_allocate_attr(stat_key, amount)
## Refund all allocated attrs to points for flat gold.
func try_attr_respec() -> Dictionary:
	return _progression_module_logic.try_attr_respec()
...
func grant_kill_exp(npc_id: String) -> Array:
	return _progression_module_logic.grant_kill_exp(npc_id)
...
func _death_drop_roll() -> float:
	return _death_drops_module_logic._death_drop_roll()
func _death_drop_item_pref(item_id: String) -> int:
	return _death_drops_module_logic._death_drop_item_pref(item_id)
func _death_drop_type_blocked(item_id: String) -> bool:
	return _death_drops_module_logic._death_drop_type_blocked(item_id)
func _apply_death_drops(actions: Array) -> void:
	return _death_drops_module_logic._apply_death_drops(actions)
...
func snapshot_titles() -> Dictionary:
	return _titles_module_logic.snapshot_titles()
func _title_update_action() -> Dictionary:
	return _titles_module_logic._title_update_action()
...
func snapshot_auction() -> Dictionary:
	return _auction_module_logic.snapshot_auction()
func _auction_update_action() -> Dictionary:
	return _auction_module_logic._auction_update_action()
func _auction_inventory_actions() -> Array:
	return _auction_module_logic._auction_inventory_actions()
func _auction_seed_npc_stubs() -> void:
	_auction_module_logic._auction_seed_npc_stubs()
func try_auction_list(item_id: String, qty: int = 1, price_gold: int = 1) -> Dictionary:
	return _auction_module_logic.try_auction_list(item_id, qty, price_gold)
